...
/* Given two array of integers(the first array is array A, the second array is array B), now we are going to 
 * find a element in array A which is A[i], and another element in array B which is B[j], so that the 
